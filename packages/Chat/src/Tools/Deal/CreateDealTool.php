...
final class CreateDealTool extends BaseWriteCreateTool
{
    public function description(): string
    {
        return 'Propose creating a new deal/deal. Optionally link to a company and primary contact.';
    }

...
#[Description('Update an existing deal (deal) in the CRM. Use the crm-schema resource to discover available custom fields.')]
#[IsIdempotent]
final class UpdateDealTool extends BaseUpdateTool
{
    ...
    {
        return [
            'name' => $schema->string()->description('The deal name.'),

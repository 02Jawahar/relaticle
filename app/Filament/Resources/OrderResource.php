...
use App\Filament\Resources\OrderResource\Pages\OrdersBoard;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('stage')
                    ...
                    ->color(fn (Order $record): array => Color::hex($record->stage->getColor()))
                    ->sortable(),
                ...
                TextColumn::make('creator.name')
                    ->label(__('filament/resources/order.fields.creator.label'))
                    ->searchable()
                    ->sortable()
                    ->toggleable()
                    ->getStateUsing(fn (Order $record): string => $record->created_by),
            ...
            ->filters([
                SelectFilter::make('creation_source')
                    ->label(__('filament/resources/order.fields.creation_source.label'))

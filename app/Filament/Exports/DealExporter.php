...
final class DealExporter extends BaseExporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('name')
                ->label(__('filament/exports.columns.deal_name')),
            ...
            ExportColumn::make('notes_count')
                ...
                ->state(fn (Deal $deal): int => $deal->notes()->count()),
            ExportColumn::make('tasks_count')
                ->label(__('filament/exports.columns.tasks_count'))
                ->state(fn (Deal $deal): int => $deal->tasks()->count()),
    ...
    public static function getCompletedNotificationBody(Export $export): string
    {
        ...
        $body = 'Your deal export has completed and '.number_format($successfulRows).' '.str('row')->plural($successfulRows).' exported.';
